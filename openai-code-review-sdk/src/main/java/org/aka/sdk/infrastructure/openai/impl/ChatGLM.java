package org.aka.sdk.infrastructure.openai.impl;
...
public class ChatGLM implements IOpenAI {
    ...
    @Override
    public ChatCompletionRequestDTO completions(ChatCompletionRequestDTO requestDTO) throws Exception{
        ...
        return JSON.parseObject(content.toString(),ChatCompletionRequestDTO.class);
    }
}
